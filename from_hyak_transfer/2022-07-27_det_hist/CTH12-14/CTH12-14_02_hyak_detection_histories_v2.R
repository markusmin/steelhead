...
write.csv(BON_arrival, "complete_BON_arrival_CTH12-14.csv", row.names = FALSE)
...
write.csv(event_site_metadata, "complete_event_site_metadata_CTH12-14.csv")
...
write.csv(event_det_counts,  "complete_event_det_counts_CTH12-14.csv", row.names = FALSE)
