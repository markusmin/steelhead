...
# for testing:
# setwd("/Users/markusmin/Documents/CBR/steelhead/to_hyak_transfer/2022-05-19_all4_1200/")
...
for (z in 9:10){
  ...
  out.jags <- 
    jags.parallel(
      data = data,
      inits = inits,
      model.file="sim_model_all4cov.txt",
...
saveRDS(JAGS_1200_list, "JAGS_all4_1200_list_5.rds")