...
# for testing:
# setwd("/Users/markusmin/Documents/CBR/steelhead/to_hyak_transfer/2022-05-18_temp_1200/")
...
for (z in 5:6){
  ...
  out.jags <- 
    jags.parallel(
      data = data,
      inits = inits,
      model.file="sim_model_cov_temp.txt",
...
saveRDS(JAGS_1200_list, "JAGS_temp_1200_list_3.rds")