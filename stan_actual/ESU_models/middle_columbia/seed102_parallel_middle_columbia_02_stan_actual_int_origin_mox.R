...
# saveRDS(fit, "200_iter_parallel_middle_columbia_stan_actual_int_origin_stan_fit.rds")
fit$save_object(file = "seed102_200_iter_parallel_middle_columbia_stan_actual_int_origin_stan_fit.rds")
