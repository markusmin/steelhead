# SNAKE - 02_stan_actual_int_origin - for mox!
...
# FOR TESTING: setwd
setwd("/Users/markusmin/Documents/CBR/steelhead/stan_actual/ESU_models/snake/")
...
non_snake_movements  <- subset(movements_df, !(row %in% c(8,9,21,22,23,24,25,26)) &
                                          !(col %in% c(8,9,21,22,23,24,25,26)))
...
n.ind <- dim(state_data)[3]
  ...
  mod <- cmdstan_model("snake_02_stan_actual_int_origin.stan", compile = FALSE)
...
saveRDS(fit, "snake_stan_actual_int_origin_stan_fit.rds")
