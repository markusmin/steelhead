...
functions{
    real partial_sum_lpmf( // int[] slice_n_fish, // I don't think that we need this, given that we are using start and end to index the detection histories
                        ...
                        array[,] real btemp2xorigin1_matrix_DE, 
                        array[,] real btemp2xorigin2_matrix_DE, 
                        array[,] real btemp2xorigin3_matrix_DE, 
                        ...
                        array[,] real btemp2xorigin1_matrix_NDE, 
                        array[,] real btemp2xorigin2_matrix_NDE, 
                        array[,] real btemp2xorigin3_matrix_NDE, 
    ...
    for (j in 1:n_obs[i]){
      // for (j in 1:n_obs[i - start + 1]){
        ...
        if (current >= 2 && current <= 9){
            ...
            // extra if - for WEL and LGR, that get an extra temp covariate
            if (current == 7) {
              temp2 = temperature_data[date, 10];
            } else if (current == 9) {
              temp2 = temperature_data[date, 11];
            } else {
              temp2 = 0;
            }
          ...
          temp = 0; 
          temp2 = 0; // this just makes it so that there's no effect of temperature,
          ...
          // need to make an exception for the first fish, which uses only the index j
            ...
            // If we're in a state/run year combo that needs DE correction, correct for it
                  ...
                  if (DE_index == 1){
                    ...
                    temp_X_mat[i,2] * btemp2xorigin1_matrix_DE[current,k] * temp2 +
                    temp_X_mat[i,3] * btemp2xorigin2_matrix_DE[current,k] * temp2 +
                    temp_X_mat[i,4] * btemp2xorigin3_matrix_DE[current,k] * temp2 +
                    ...
                    temp_X_mat[i,2] * btemp2xorigin1_matrix_NDE[current,k] * temp2 +
                    temp_X_mat[i,3] * btemp2xorigin2_matrix_NDE[current,k] * temp2 +
                    temp_X_mat[i,4] * btemp2xorigin3_matrix_NDE[current,k] * temp2 +
...
real btemp2xorigin1_matrix_7_28_DE;
real btemp2xorigin1_matrix_7_28_NDE;
real btemp2xorigin1_matrix_7_30_DE;
real btemp2xorigin1_matrix_7_30_NDE;
real btemp2xorigin1_matrix_7_42;
real btemp2xorigin2_matrix_7_28_DE;
real btemp2xorigin2_matrix_7_28_NDE;
real btemp2xorigin2_matrix_7_30_DE;
real btemp2xorigin2_matrix_7_30_NDE;
real btemp2xorigin2_matrix_7_42;
real btemp2xorigin3_matrix_7_28_DE;
real btemp2xorigin3_matrix_7_28_NDE;
real btemp2xorigin3_matrix_7_30_DE;
real btemp2xorigin3_matrix_7_30_NDE;
real btemp2xorigin3_matrix_7_42;
...
transformed parameters {
  ...
  // Declare matrices to store origin x second temperature interactions (DE and NDE)
  // Origin 1 x temp
  array[43,43] real btemp2xorigin1_matrix_DE;
  btemp2xorigin1_matrix_DE = rep_array(0, 43, 43);
  array[43,43] real btemp2xorigin1_matrix_NDE;
  btemp2xorigin1_matrix_NDE = rep_array(0, 43, 43);
  // Origin 2 x temp
  array[43,43] real btemp2xorigin2_matrix_DE;
  btemp2xorigin2_matrix_DE = rep_array(0, 43, 43);
  array[43,43] real btemp2xorigin2_matrix_NDE;
  btemp2xorigin2_matrix_NDE = rep_array(0, 43, 43);
  // Origin 3 x temp
  array[43,43] real btemp2xorigin3_matrix_DE;
  btemp2xorigin3_matrix_DE = rep_array(0, 43, 43);
  array[43,43] real btemp2xorigin3_matrix_NDE;
  btemp2xorigin3_matrix_NDE = rep_array(0, 43, 43);
...
btemp2xorigin1_matrix_DE[7,28] = btemp2xorigin1_matrix_7_28_DE;
btemp2xorigin1_matrix_NDE[7,28] = btemp2xorigin1_matrix_7_28_NDE;
btemp2xorigin1_matrix_NDE[7,29] = btemp2xorigin1_matrix_7_28_NDE;
btemp2xorigin1_matrix_DE[7,30] = btemp2xorigin1_matrix_7_30_DE;
btemp2xorigin1_matrix_NDE[7,30] = btemp2xorigin1_matrix_7_30_NDE;
btemp2xorigin1_matrix_NDE[7,31] = btemp2xorigin1_matrix_7_30_NDE;
btemp2xorigin1_matrix_DE[7,42] = btemp2xorigin1_matrix_7_42;
btemp2xorigin1_matrix_NDE[7,42] = btemp2xorigin1_matrix_7_42;

btemp2xorigin2_matrix_DE[7,28] = btemp2xorigin2_matrix_7_28_DE;
btemp2xorigin2_matrix_NDE[7,28] = btemp2xorigin2_matrix_7_28_NDE;
btemp2xorigin2_matrix_NDE[7,29] = btemp2xorigin2_matrix_7_28_NDE;
btemp2xorigin2_matrix_DE[7,30] = btemp2xorigin2_matrix_7_30_DE;
btemp2xorigin2_matrix_NDE[7,30] = btemp2xorigin2_matrix_7_30_NDE;
btemp2xorigin2_matrix_NDE[7,31] = btemp2xorigin2_matrix_7_30_NDE;
btemp2xorigin2_matrix_DE[7,42] = btemp2xorigin2_matrix_7_42;
btemp2xorigin2_matrix_NDE[7,42] = btemp2xorigin2_matrix_7_42;

btemp2xorigin3_matrix_DE[7,28] = btemp2xorigin3_matrix_7_28_DE;
btemp2xorigin3_matrix_NDE[7,28] = btemp2xorigin3_matrix_7_28_NDE;
btemp2xorigin3_matrix_NDE[7,29] = btemp2xorigin3_matrix_7_28_NDE;
btemp2xorigin3_matrix_DE[7,30] = btemp2xorigin3_matrix_7_30_DE;
btemp2xorigin3_matrix_NDE[7,30] = btemp2xorigin3_matrix_7_30_NDE;
btemp2xorigin3_matrix_NDE[7,31] = btemp2xorigin3_matrix_7_30_NDE;
btemp2xorigin3_matrix_DE[7,42] = btemp2xorigin3_matrix_7_42;
btemp2xorigin3_matrix_NDE[7,42] = btemp2xorigin3_matrix_7_42;
...
btemp2xorigin1_matrix_7_28_DE ~ normal(0,10);
btemp2xorigin1_matrix_7_28_NDE ~ normal(0,10);
btemp2xorigin1_matrix_7_30_DE ~ normal(0,10);
btemp2xorigin1_matrix_7_30_NDE ~ normal(0,10);
btemp2xorigin1_matrix_7_42 ~ normal(0,10);

btemp2xorigin2_matrix_7_28_DE ~ normal(0,10);
btemp2xorigin2_matrix_7_28_NDE ~ normal(0,10);
btemp2xorigin2_matrix_7_30_DE ~ normal(0,10);
btemp2xorigin2_matrix_7_30_NDE ~ normal(0,10);
btemp2xorigin2_matrix_7_42 ~ normal(0,10);

btemp2xorigin3_matrix_7_28_DE ~ normal(0,10);
btemp2xorigin3_matrix_7_28_NDE ~ normal(0,10);
btemp2xorigin3_matrix_7_30_DE ~ normal(0,10);
btemp2xorigin3_matrix_7_30_NDE ~ normal(0,10);
btemp2xorigin3_matrix_7_42 ~ normal(0,10);
...
// break up the dataset by fish and therefore run different chunks of the dataset in parallel.
  ...
  btemp2xorigin1_matrix_DE, btempxorigin2_matrix_DE, btempxorigin3_matrix_DE, // arguments 22-24
  btemp_matrix_NDE, btempxorigin1_matrix_NDE, btempxorigin2_matrix_NDE, btempxorigin3_matrix_NDE, // arguments 25-28
  btemp2xorigin1_matrix_NDE, btemp2xorigin2_matrix_NDE, btemp2xorigin3_matrix_NDE, // arguments 29-31
  tributary_design_matrices_array, transition_run_years, run_year_DE_array, det_eff_param_vector); // arguments 32-35
