...
// this model has as covariate temperature (two covariates for each state) and origin
...
// break up the dataset by fish and therefore run different chunks of the dataset in parallel.
  ...
  tributary_design_matrices_array, transition_run_years, nyears, run_year_DE_array, det_eff_param_vector); // arguments 41-45
