# Stan result visualization, temperature models
...
write.csv(upper_columbia_DE_DPS_probs, here::here("stan_actual", "rear_temp", "processed", "wild_upper_columbia_temp_DE_DPS_probs.csv"))
write.csv(upper_columbia_DE_origin_probs, here::here("stan_actual", "rear_temp", "processed", "wild_upper_columbia_temp_DE_origin_probs.csv"))
