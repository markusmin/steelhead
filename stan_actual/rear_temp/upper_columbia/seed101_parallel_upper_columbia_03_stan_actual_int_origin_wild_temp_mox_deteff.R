...
# FOR TESTING: setwd
# setwd("/Users/markusmin/Documents/CBR/steelhead/stan_actual/rear_temp/upper_columbia/")
...
n.ind <- dim(state_data)[3]
  ...
  mod <- cmdstan_model("parallel_upper_columbia_03_stan_actual_int_origin_wild_temp_deteff.stan", compile = FALSE)
