...
# TEMPORARY - since only two chains finished, read them each twice
...
SRH_chain2 <- readRDS(here::here("stan_actual", "reparameterization_v2_marchspilldays", "snake_river_hatchery", "chain1_SRH_reparam_v2_fit.rds"))
SRH_chain3 <- readRDS(here::here("stan_actual", "reparameterization_v2_marchspilldays", "snake_river_hatchery", "chain4_SRH_reparam_v2_fit.rds"))
...
for (i in 1:nrow(UC_postovershoot_fallback_movements)){
  ...
  if(nrow(WEN_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("WEN_compare_fallback_", 
...
for (i in 1:nrow(UC_postovershoot_fallback_movements)){
  ...
  if(nrow(ENT_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("ENT_compare_fallback_", 
                                                                                  UC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(DES_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("DES_compare_fallback_", 
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(JDR_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("JDR_compare_fallback_", 
                                                                                  MC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(FIF_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("FIF_compare_fallback_", 
                                                                                  MC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(UMA_wild_data_to_plot)>0 | nrow(UMA_hatchery_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("UMA_compare_fallback_", 
                                                                                  MC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(YAK_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("YAK_compare_fallback_", 
                                                                                  MC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(MC_postovershoot_fallback_movements)){
  ...
  if(nrow(WAWA_wild_data_to_plot)>0 | nrow(WAWA_hatchery_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("WAWA_compare_fallback_", 
                                                                                  MC_postovershoot_fallback_movements$dam[i],
                                                                                  "_spilldays.png")),
...
for (i in 1:nrow(SR_postovershoot_fallback_movements)){
  ...
  if(nrow(TUC_wild_data_to_plot)>0 | nrow(TUC_hatchery_data_to_plot)>0){
    ...
    ggsave(here::here("stan_actual", "output", "fit_to_data", "spilldays_march", paste0("TUC_compare_fallback_", 
