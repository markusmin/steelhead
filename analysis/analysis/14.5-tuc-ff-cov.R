...
LGR_winter_spill_values <- c(0, 0.10, 0.20,0.30, 0.40, 0.50)
...
TUC_LGR_winterspill_homing_plot <- ggplot(TUC_LGR_winterspill_homing, aes(x = LGR_winterspill_actual, y = `0.5`, ymin = `0.025`, ymax = `0.975`, color = rear_type,
                                                                          shape = conditions)) +
