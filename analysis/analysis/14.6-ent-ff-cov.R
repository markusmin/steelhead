...
WEL_winter_spill_values <- c(0, 0.10, 0.20,0.30, 0.40, 0.50)
...
ENT_WEL_winterspill_homing_plot <- ggplot(ENT_WEL_winterspill_homing, aes(x = WEL_winterspill_actual, y = `0.5`, ymin = `0.025`, ymax = `0.975`, color = rear_type,
                                                                          shape = conditions)) +
