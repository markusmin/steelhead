...
# Input file: complete detection histories from 03 script
...
states_complete_part1 <- read.csv(here::here("analysis", "03-complete-det-hist", "states_complete_part1.csv"), row.names = 1)
states_complete_part2 <- read.csv(here::here("analysis", "03-complete-det-hist", "states_complete_part2.csv"), row.names = 1)
states_complete_part3 <- read.csv(here::here("analysis", "03-complete-det-hist", "states_complete_part3.csv"), row.names = 1)
states_complete_part4 <- read.csv(here::here("analysis", "03-complete-det-hist", "states_complete_part4.csv"), row.names = 1)
...
# Let's check our transition tables as well to make sure we don't have any transitions that aren't allowed
transitions_table_part1 <- read.csv(here::here("analysis", "03-complete-det-hist", "state_transitions_table_part1.csv"), row.names = 1)
transitions_table_part2 <- read.csv(here::here("analysis", "03-complete-det-hist", "state_transitions_table_part2.csv"), row.names = 1)
transitions_table_part3 <- read.csv(here::here("analysis", "03-complete-det-hist", "state_transitions_table_part3.csv"), row.names = 1)
transitions_table_part4 <- read.csv(here::here("analysis", "03-complete-det-hist", "state_transitions_table_part4.csv"), row.names = 1)

transitions_table_part1 %>% 
  bind_rows(transitions_table_part2) %>% 
  bind_rows(transitions_table_part3) %>% 
  bind_rows(transitions_table_part4) %>% 
  group_by(Var1) %>%
  summarise_all(., sum, na.rm = TRUE) -> transitions_table_all

view(transitions_table_all)
...
write.csv(snake_adults_only_states, here::here("model_files", "stan_inputs", "snake_adults_states_complete.csv"))
write.csv(upper_columbia_adults_only_states, here::here("model_files", "stan_inputs",  "upper_columbia_adults_states_complete.csv"))
write.csv(middle_columbia_adults_only_states, here::here("model_files", "stan_inputs",  "middle_columbia_adults_states_complete.csv"))
write.csv(lower_columbia_adults_only_states, here::here("model_files", "stan_inputs",  "lower_columbia_adults_states_complete.csv"))
