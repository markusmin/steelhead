...
![R-hat statistics. R-hat values should be less than 1.05, and all
parameters here have an R-hat of less than
1.01.](site_figures/conv_eff/rhat_comb_plots.png)
...
![Upper Columbia Wild Steelhead, ascending McNary Dam (moving from state
2, BON to MCN, to state 3, MCN to PRA or
ICH).](site_figures/pairs_plots/UCW/_2_3_pairs_plot.png)

<br>
<br>

![Snake River Hatchery Steelhead, ascending McNary Dam (moving from
state 2, BON to MCN, to state 3, MCN to PRA or
ICH).](site_figures/pairs_plots/SRH/_2_3_pairs_plot.png)
...
![Snake River Steelhead ascents at McNary Dam by day of year and
temperature.](site_figures/covariate_plots/SR_MCN_temp_v_date.png){width=50%}
...
![Upper Columbia Wild Steelhead, descending Rocky Reach Dam (moving from
state 6, which is RRE to WEL, to state 5, which is RIS to
RRE).](site_figures/pairs_plots/UCW/_6_5_pairs_plot.png) <br>
...
![Upper Columbia Wild Steelhead, falling back over Bonneville Dam
(moving from state 2, which is BON to MCN, to state 1, which is mouth to
BON).](site_figures/pairs_plots/UCW/_2_1_pairs_plot.png)
