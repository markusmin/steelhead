...
![Upper Columbia Wild Steelhead, ascending McNary Dam (moving from state 2, BON to MCN, to state 3, MCN to PRA or ICH).](site_figures/output_spillrescaled/pairs_plots/UCW/2_3_pairs_plot.png){width=50%}

<br>

![Snake River Hatchery Steelhead, ascending McNary Dam (moving from state 2, BON to MCN, to state 3, MCN to PRA or ICH).](site_figures/output_spillrescaled/pairs_plots/SRH/2_3_pairs_plot.png){width=50%}
