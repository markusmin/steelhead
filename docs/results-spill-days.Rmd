...
If a tributary has both a hatchery and natural origin population, they are shown on the same plot. The rug plot (lines in the margins) indicate the number of observations at each number of winter spill days, where the fish was also in the upstream state during the winter months.
