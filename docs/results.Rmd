...
Comparing estimates for key parameters is one way to visualize this. However, comparing parameter estimates on their own is not the full picture, as seen by the collinearity between parameters that can be seen on the diagnostics tab. Here is an example:
