...
1. A consistent issue across many populations is an overestimation of straying rates, particularly into the Deschutes River. See the "Outstanding issues" tab for a deep dive into this issue, which I am still trying to resolve.
