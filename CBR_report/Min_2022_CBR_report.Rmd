...
An additional step was to identify antennas in adult fish facilities/traps at ladders. For most dams, detections in the adult fish facility were treated the same as detections in other parts of the adult ladder, as trapping did not take place and thus fish were not removed. However, in the case of Wells Dam, fish that were trapped were removed and either moved to the hatchery or trucked off-site. As such, any terminal detections in the trap at Wells Dam were treated as trapping events.
