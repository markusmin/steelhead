...
flextable(out_of_ESU_counts_table) %>% 
  align(part = "all") %>% # left align
  set_caption(caption = "Number and percent of tagged individuals seen in reaches of the Colubmia or Snake outside of the DPS boundaries that are not necessary for homing. For Middle Columbia Steelhead, this is defined as reaches upstream of Priest Rapids Dam on the Upper Columbia River or upstream of Ice Harbor Dam on the Snake River; for Upper Columbia Steelhead, this is defined as reaches upstream of Ice Harbor Dam on the Snake River, and for Snake River Basin Steelhead, this is defined as reaches upstream of Priest Rapids Dam on the Upper Columbia River.")  %>% 
  font(fontname = "Times New Roman (Body)", part = "all") %>% 
  fontsize(size = 10, part = "body") %>% 
  theme_booktabs() %>% # default theme
  FitFlextableToPage()
