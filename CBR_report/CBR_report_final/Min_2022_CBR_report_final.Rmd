...
flextable(overshooting_homing_probs) %>% 
  ...
  set_caption(caption = "Probability of successfully homing, conditional on making it to the section of mainstem into which the home tributary flows, or conditional on overshooting the dam directly upstream of the home tributary.") %>% 
...
# Appendix 1: Individual movement probabilities

## Appendix 1a. Middle Columbia River Steelhead
...
## Appendix 1b. Upper Columbia River Steelhead
```{r echo = FALSE, message = FALSE, warning = FALSE}
# Upper Columbia
...
## Appendix 1c. Snake River Basin Steelhead
```{r echo = FALSE, message = FALSE, warning = FALSE}
# Snake River
