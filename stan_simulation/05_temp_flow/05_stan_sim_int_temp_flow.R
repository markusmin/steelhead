...
# FOR TESTING: setwd
setwd("/Users/markusmin/Documents/CBR/steelhead/stan_simulation/05_temp_flow")
...
# for (z in 1:1){
  ...
  mod <- cmdstan_model("05_stan_sim_int_temp_flow.stan", compile = FALSE)
  ...
  stan_1200_temp_flow_list[[z]] <- fit$summary(variables = c("b0_matrix_2_1", 
                                                   "b0_matrix_1_2",
                                                   "b0_matrix_3_2",
                                                   "b0_matrix_6_2",
                                                   "b0_matrix_7_2",
...
simulation_plots_temp_flow <- function(stan_list){
...
sim1200_temp_flow_plots <- simulation_plots_temp_flow(stan_list = stan_1200_temp_flow_list)
ggsave(here::here("stan_simulation", "05_temp_flow", "stan_temp_flow_summary_plot_b0.png"), height = 6, width = 10, sim1200_temp_flow_plots[[1]])
ggsave(here::here("stan_simulation", "05_temp_flow", "stan_temp_flow_summary_plot_btemp.png"), height = 6, width = 10, sim1200_temp_flow_plots[[2]])
ggsave(here::here("stan_simulation", "05_temp_flow", "stan_temp_flow_summary_plot_bflow.png"), height = 6, width = 10, sim1200_temp_flow_plots[[3]])
