# 03_stan_sim_int_origin

# This script will fit an intercept only model using stan to the simulated data.
# The data is the same as was used for fitting the JAGS model.

# FOR TESTING: setwd
setwd("/Users/markusmin/Documents/CBR/steelhead/stan_simulation/03_origin_rear")
...
stan_1200_origin_rear_list <- list()
# Loop it
...
# for (z in 1:1){
  ...
  mod <- cmdstan_model("03_stan_sim_int_origin_rear.stan", compile = FALSE)
  ...
  stan_1200_origin_rear_list[[z]] <- fit$summary(variables = c("b0_matrix_2_1", 
                                                   "b0_matrix_1_2",
                                                   "b0_matrix_3_2",
                                                   "b0_matrix_6_2",
                                                   "b0_matrix_7_2",
...
simulation_plots_origin_rear <- function(stan_list){
...
sim1200_origin_rear_plots <- simulation_plots_origin_rear(stan_list = stan_1200_origin_rear_list)
ggsave(here::here("stan_simulation", "03_origin_rear", "stan_origin_rear_summary_plot_b0.png"), height = 6, width = 10, sim1200_origin_rear_plots[[1]])
ggsave(here::here("stan_simulation", "03_origin_rear", "stan_origin_rear_summary_plot_brear.png"), height = 6, width = 10, sim1200_origin_rear_plots[[2]])
ggsave(here::here("stan_simulation", "03_origin_rear", "stan_origin_rear_summary_plot_borigin1.png"), height = 6, width = 10, sim1200_origin_rear_plots[[3]])
ggsave(here::here("stan_simulation", "03_origin_rear", "stan_origin_rear_summary_plot_borigin2.png"), height = 6, width = 10, sim1200_origin_rear_plots[[4]])
