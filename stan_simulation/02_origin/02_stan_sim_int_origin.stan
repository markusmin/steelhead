  ...
  for (i in 1:n_ind){
    ...
    for (j in 1:n_obs[i]){
        ...
        for (l in 1:n_possible_transitions){
          logits[possible_transitions[current,l]] = b0_matrix[current, possible_transitions[current,l]] + cat_X_mat[i,2] * borigin1_matrix[current,possible_transitions[current,l]] + 
          cat_X_mat[i,3] * borigin2_matrix[current,possible_transitions[current,l]];
        }
