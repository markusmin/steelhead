...
# before z-scoring, export the mean and SD of each set of window spill
window_spill %>% 
  ...
  filter(!duplicated(BON_mean)) -> window_spill_summary
...
window_spill %>% 
  ...
  mutate(LGR_slow = (LGR_slow - mean(LGR_slow))/sd(LGR_slow)) -> window_spill
...
write.csv(window_spill_summary, here::here("covariate_data", "for_model", "window_spill_summary.csv"))
...
BON_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> BON_monthly_spill
...
MCN_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> MCN_monthly_spill
...
PRA_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> PRA_monthly_spill
...
RIS_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> RIS_monthly_spill
...
RRE_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> RRE_monthly_spill
...
WEL_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> WEL_monthly_spill
...
ICH_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> ICH_monthly_spill
...
LGR_march_spill %>% 
  ...
  pivot_longer(., cols = c("march_spill_days", "february_spill_days", "january_spill_days")) -> LGR_monthly_spill
