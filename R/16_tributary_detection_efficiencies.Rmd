...
# calculate annual (by run year) means for discharge/gage height
...
# add this plot for all tributaries!

ggplot(monthly_discharge, aes(x = month, y = mean_discharge_cfs, color = as.factor(year))) +
  geom_point() +
