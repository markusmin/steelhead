...
### Load complete detection history files
CTH_1 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_1.csv")))
CTH_2 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_2.csv")))
CTH_3 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_3.csv")))
CTH_4 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_4.csv")))
CTH_5 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_5.csv")))
CTH_6 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_6.csv")))
CTH_7 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_7.csv")))
CTH_8 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_8.csv")))
CTH_9 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_9.csv")))
CTH_10 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_10.csv")))
CTH_11 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_11.csv")))
CTH_12 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_12.csv")))
CTH_13 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_13.csv")))
CTH_14 <- clean_names(read.csv(here::here("PTAGIS_queries", "complete_tag_histories", "CTH_tag_codes_14.csv")))
...
CTH_adult %>% 
  ...
  mutate(event_site_name = ifelse(event_site_name %in% c("TD1 - The Dalles East Fish Ladder", "TD2 - The Dalles North Fish Ladder"),
                                  "The Dalles Adult Fishways (combined)", event_site_name)) %>% 
  mutate(event_site_name = ifelse(event_site_name %in% c("LGRLDR - LGR - Release into the Adult Fish Ladder", "GRA - Lower Granite Dam Adult"),
                                  "Lower Granite Dam Adult Fishways (combined)", event_site_name)) -> CTH_adult
