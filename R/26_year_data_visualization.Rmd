...
**Note:** Some of the trends you see by year are a result of the changing sample sizes of DPSs, rather than changes in underlying movement probabilities.
...
MCN_to_ICH_or_PRA_movement_summary <- state_movement_summary(from_state = "mainstem, MCN to ICH or PRA")
...
*Note that this pattern is driven primarily by sample sizes of different populations.*


```{r}
# mainstem, PRA_to_RIS
PRA_to_RIS_movement_summary <- state_movement_summary(from_state = "mainstem, PRA to RIS")
...
```{r}
# mainstem, RIS_to_RRE
RIS_to_RRE_movement_summary <- state_movement_summary(from_state = "mainstem, RIS to RRE")
...
```{r}
# mainstem, RRE_to_WEL
RRE_to_WEL_movement_summary <- state_movement_summary(from_state = "mainstem, RRE to WEL")
...
upstream_WEL_movement_summary <- state_movement_summary(from_state = "mainstem, upstream of WEL")
...
```{r}
# mainstem, ICH_to_LGR
ICH_to_LGR_movement_summary <- state_movement_summary(from_state = "mainstem, ICH to LGR")
...
upstream_LGR_movement_summary <- state_movement_summary(from_state = "mainstem, upstream of LGR")
