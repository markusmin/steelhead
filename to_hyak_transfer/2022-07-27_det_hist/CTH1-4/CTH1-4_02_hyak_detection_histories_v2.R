...
# For testing - setwd
# setwd("/Users/markusmin/Documents/CBR/steelhead/to_hyak_transfer/2022-07-27_det_hist/CTH1-4")
...
CTH_1 <- clean_names(read.csv("2022-07-25-CTH1.csv"))
CTH_2 <- clean_names(read.csv("2022-07-28-CTH2.csv"))
CTH_3 <- clean_names(read.csv("2022-07-28-CTH3.csv"))
CTH_4 <- clean_names(read.csv("2022-07-28-CTH4.csv"))
...
write.csv(BON_arrival, "complete_BON_arrival_CTH1-4.csv", row.names = FALSE)
...
write.csv(det_hist_PST, "complete_det_hist_CTH1-4.csv")
...
write.csv(event_site_metadata, "complete_event_site_metadata_CTH1-4.csv")
...
write.csv(event_det_counts,  "complete_event_det_counts_CTH1-4.csv", row.names = FALSE)
