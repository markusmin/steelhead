...
# For testing - setwd
# setwd("/Users/markusmin/Documents/CBR/steelhead/to_hyak_transfer/2022-07-27_det_hist/CTH9-11/")
...
CTH_9 <- clean_names(read.csv("2022-07-28-CTH9.csv"))
CTH_10 <- clean_names(read.csv("2022-07-28-CTH10.csv"))
CTH_11 <- clean_names(read.csv("2022-07-28-CTH11.csv"))
...
write.csv(BON_arrival, "complete_BON_arrival_CTH9-11.csv", row.names = FALSE)
...
write.csv(det_hist_PST, "complete_det_hist_CTH9-11.csv")
...
write.csv(event_site_metadata, "complete_event_site_metadata_CTH9-11.csv")
...
write.csv(event_det_counts,  "complete_event_det_counts_CTH9-11.csv", row.names = FALSE)
