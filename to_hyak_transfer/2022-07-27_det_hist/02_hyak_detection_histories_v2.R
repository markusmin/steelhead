...
# The for loop from this script gets copied to the other scripts
# that are then run for the specific detection history files
...
write.csv(det_hist_PST, "complete_det_hist_CTH1.csv")
